...
type VarLocalView interface {
	...
	Value() *iscmove_types.Anchor
	//
	// Corresponds to the `tx_posted` event in the specification.
	// Returns true, if the proposed BaseAliasOutput has changed.
	ConsensusOutputDone(logIndex LogIndex, consumed sui.ObjectID, published *iscmove_types.Anchor) (*iscmove_types.Anchor, bool) // TODO: Recheck, if consumed AO is the decided one.
	//
	...
	AliasOutputConfirmed(confirmed *iscmove_types.Anchor) (*iscmove_types.Anchor, bool, LogIndex)
	//
	// Corresponds to the `tx_rejected` event in the specification.
	// Returns true, if the proposed BaseAliasOutput has changed.
	AliasOutputRejected(rejected *iscmove_types.Anchor) (*iscmove_types.Anchor, bool)
	//
	// Support functions.
	StatusString() string
}
...
type varLocalViewEntry struct {
	output   *iscmove_types.Anchor // The AO published.
...
type varLocalViewImpl struct {
	...
	confirmed *iscmove_types.Anchor
	...
	tipUpdatedCB func(ao *iscmove_types.Anchor)
	// Just a logger.
	log *logger.Logger
}

func NewVarLocalView(pipeliningLimit int, tipUpdatedCB func(ao *iscmove_types.Anchor), log *logger.Logger) VarLocalView {
...
func (lvi *varLocalViewImpl) Value() *iscmove_types.Anchor {
	return lvi.findLatestPending()
}

func (lvi *varLocalViewImpl) ConsensusOutputDone(logIndex LogIndex, consumed sui.ObjectID, published *iscmove_types.Anchor) (*iscmove_types.Anchor, bool) {
...
func (lvi *varLocalViewImpl) AliasOutputConfirmed(confirmed *iscmove_types.Anchor) (*iscmove_types.Anchor, bool, LogIndex) {
...
func (lvi *varLocalViewImpl) AliasOutputRejected(rejected *iscmove_types.Anchor) (*iscmove_types.Anchor, bool) {
...
func (lvi *varLocalViewImpl) markDependentAsRejected(ao *iscmove_types.Anchor) {
...
func (lvi *varLocalViewImpl) outputIfChanged(oldTip, newTip *iscmove_types.Anchor) (*iscmove_types.Anchor, bool) {
...
// are not rejected.
func (lvi *varLocalViewImpl) findLatestPending() *iscmove_types.Anchor {
	if lvi.confirmed == nil {
		return nil
	}
...
func (lvi *varLocalViewImpl) isAliasOutputPending(ao *iscmove_types.Anchor) bool {
	found := false
	lvi.pending.ForEach(func(si uint32, es []*varLocalViewEntry) bool {
