...
type Mempool interface {
	...
	TrackNewChainHead(st state.State, from, till *types.Anchor, added, removed []state.Block) <-chan bool
...
func (mpi *mempoolImpl) TrackNewChainHead(st state.State, from, till *types.Anchor, added, removed []state.Block) <-chan bool {
...
func (mpi *mempoolImpl) ConsensusProposalAsync(ctx context.Context, aliasOutput *types.Anchor, consensusID consGR.ConsensusID) <-chan []*isc.RequestRef {
