...
type chainMgrImpl struct {
	...
	trackActiveStateCB         func(ao *iscmove.RefWithObject[iscmove.Anchor])               // We will call this to set new AO for the active state.
...
func New(
	...
	trackActiveStateCB func(ao *iscmove.RefWithObject[iscmove.Anchor]),
