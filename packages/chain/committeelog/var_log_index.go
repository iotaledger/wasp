...
func (vli *VarLogIndex) MsgNextLogIndexReceived(msg *MsgNextLogIndex) OutMessages {
...
func (vli *VarLogIndex) msgNextLogIndexOnStarted(msg *MsgNextLogIndex) OutMessages {
