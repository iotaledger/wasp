...
func (vli *VarLogIndex) MsgNextLogIndexReceived(msg gpa.MessageIn[MsgNextLogIndex]) []gpa.MessageOut {
...
func (vli *VarLogIndex) msgNextLogIndexOnStarted(msg gpa.MessageIn[MsgNextLogIndex]) []gpa.MessageOut {
