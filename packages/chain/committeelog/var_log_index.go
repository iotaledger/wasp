...
type LogIndexVariable interface {
...
type logIndexVariableImpl struct {
...
func (vli *logIndexVariableImpl) StatusString() string {
	return fmt.Sprintf(
		"{logIndexVariable: minLI=%v, agreedLI=%v}",
		vli.minLI, vli.agreedLI,
	)
}

func (vli *logIndexVariableImpl) ConsensusStarted(consensusLI LogIndex) gpa.OutMessages {
...
func (vli *logIndexVariableImpl) MsgNextLogIndexReceived(msg *MsgNextLogIndex) gpa.OutMessages {
...
func (vli *logIndexVariableImpl) msgNextLogIndexOnStarted(msg *MsgNextLogIndex) gpa.OutMessages {
	vli.qcStarted.VoteReceived(msg)
	return vli.tryOutputOnStarted()
}

func (vli *logIndexVariableImpl) tryOutputOnStarted() gpa.OutMessages {
...
func (vli *logIndexVariableImpl) tryOutput(li LogIndex, cause MsgNextLogIndexCause) gpa.OutMessages {
...
func (vli *logIndexVariableImpl) knownNodeID(nodeID gpa.NodeID) bool {
