...
func (sub *syncMempoolImpl) BaseAnchorReceived(baseAnchor *isc.StateAnchor) gpa.OutMessages {
...
func (sub *syncMempoolImpl) ProposalReceived(requestRefs []*isc.RequestRef) gpa.OutMessages {
...
func (sub *syncMempoolImpl) RequestsNeeded(requestRefs []*isc.RequestRef) gpa.OutMessages {
...
func (sub *syncMempoolImpl) RequestsReceived(requests []isc.Request) gpa.OutMessages {
...
func (sub *syncMempoolImpl) String() string {
	str := "Mempool"
