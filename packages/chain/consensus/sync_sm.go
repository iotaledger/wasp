...
func (s *SyncStateMgr) ProposedBaseAnchorReceived(baseAnchor *isc.StateAnchor) gpa.OutMessages {
...
func (s *SyncStateMgr) StateProposalConfirmedByStateMgr() gpa.OutMessages {
...
func (s *SyncStateMgr) DecidedVirtualStateNeeded(decidedBaseAnchor *isc.StateAnchor) gpa.OutMessages {
...
func (s *SyncStateMgr) BlockProduced(block state.StateDraft) gpa.OutMessages {
...
func (s *SyncStateMgr) BlockSaved(block state.Block) gpa.OutMessages {
