...
func (sub *syncStateMgrImpl) ProposedBaseAnchorReceived(baseAnchor *isc.StateAnchor) gpa.OutMessages {
...
func (sub *syncStateMgrImpl) StateProposalConfirmedByStateMgr() gpa.OutMessages {
...
func (sub *syncStateMgrImpl) DecidedVirtualStateNeeded(decidedBaseAnchor *isc.StateAnchor) gpa.OutMessages {
...
func (sub *syncStateMgrImpl) DecidedVirtualStateReceived(
...
func (sub *syncStateMgrImpl) BlockProduced(block state.StateDraft) gpa.OutMessages {
...
func (sub *syncStateMgrImpl) BlockSaved(block state.Block) gpa.OutMessages {
...
func (sub *syncStateMgrImpl) String() string {
	str := "StateMgr"
