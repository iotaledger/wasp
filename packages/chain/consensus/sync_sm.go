...
func (s *SyncStateMgr) ProposedBaseAnchorReceived(baseAnchor *isc.StateAnchor) []gpa.PayloadOut {
...
func (s *SyncStateMgr) StateProposalConfirmedByStateMgr() []gpa.PayloadOut {
...
func (s *SyncStateMgr) DecidedVirtualStateNeeded(decidedBaseAnchor *isc.StateAnchor) []gpa.PayloadOut {
...
func (s *SyncStateMgr) BlockProduced(block state.StateDraft) []gpa.PayloadOut {
...
func (s *SyncStateMgr) BlockSaved(block state.Block) []gpa.PayloadOut {
