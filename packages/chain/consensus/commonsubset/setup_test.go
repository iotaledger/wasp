...
func NewCommitteeMock(peeringID peering.PeeringID, group peering.GroupProvider, t *testing.T) *committeeMock {
...
func (cmT *committeeMock) SendMsgByIndex(peerIdx uint16, msgReceiver byte, msgType byte, msgData []byte) error {
...
func (cmT *committeeMock) SendMsgBroadcast(msgReceiver byte, msgType byte, msgData []byte, except ...uint16) {
	panic("Not implemented")
}
