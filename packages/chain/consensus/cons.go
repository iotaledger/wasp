...
func (c *Consensus) uponDSSInitialInputsReady() gpa.OutMessages {
...
func (c *Consensus) uponDSSSigningInputsReceived(decidedIndexProposals map[gpa.NodeID][]int, messageToSign []byte) gpa.OutMessages {
