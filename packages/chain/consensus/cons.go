...
type Consensus struct {
	...
	me                      gpa.NodeID
	f                       int
	distributedSignature    *gpa.OwnHandler[*distsign.DistributedSignature]
	acs                     *gpa.OwnHandler[*acs.ACS]
...
func New( //nolint:funlen
	...
	c := &Consensus{
		...
		me:                   me,
		f:                    f,
		distributedSignature: gpa.NewOwnHandler(me, distsign.New(edSuite, nodeIDs, nodePKs, f, me, myKyberKeys.Private, longTermDKS, log.NewChildLogger("DistributedSignature"))),
		acs:                  gpa.NewOwnHandler(me, acs.New(nodeIDs, me, f, acsCCInstFunc, acsLog)),
