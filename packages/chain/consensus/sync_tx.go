...
func (sub *SyncTX) AnchorDecided(ao *isc.StateAnchor) []gpa.PayloadOut {
...
func (sub *SyncTX) UnsignedTXReceived(unsignedTX *iotago.TransactionData) []gpa.PayloadOut {
...
func (sub *SyncTX) SignatureReceived(signature []byte) []gpa.PayloadOut {
...
func (sub *SyncTX) BlockSaved(block state.Block) []gpa.PayloadOut {
	if sub.blockSaved {
		return nil
	}
	sub.blockSaved = true
...
func (sub *SyncTX) tryCompleteInputs() []gpa.PayloadOut {
