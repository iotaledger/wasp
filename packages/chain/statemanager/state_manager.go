...
type StateMgr interface {
	...
	ChainFetchStateDiff(
		ctx context.Context,
		prevAnchor, nextAnchor *isctypes.Anchor,
...
func (smT *stateManager) ChainFetchStateDiff(ctx context.Context, prevAnchor, nextAnchor *isctypes.Anchor) <-chan *sm_inputs.ChainFetchStateDiffResults {
...
func (smT *stateManager) ConsensusStateProposal(ctx context.Context, anchor *isctypes.Anchor) <-chan interface{} {
...
func (smT *stateManager) ConsensusDecidedState(ctx context.Context, anchor *isctypes.Anchor) <-chan state.State {
