...
type StateMgr interface {
	...
	ChainFetchStateDiff(
		ctx context.Context,
		prevAnchor, nextAnchor *iscmove_types.Anchor,
...
func (smT *stateManager) ChainFetchStateDiff(ctx context.Context, prevAnchor, nextAnchor *iscmove_types.Anchor) <-chan *sm_inputs.ChainFetchStateDiffResults {
...
func (smT *stateManager) ConsensusStateProposal(ctx context.Context, anchor *iscmove_types.Anchor) <-chan interface{} {
...
func (smT *stateManager) ConsensusDecidedState(ctx context.Context, anchor *iscmove_types.Anchor) <-chan state.State {
