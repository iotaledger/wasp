...
type StateMgr interface {
	...
	ChainFetchStateDiff(
		ctx context.Context,
		prevAnchor, nextAnchor *types.Anchor,
...
func (smT *stateManager) ChainFetchStateDiff(ctx context.Context, prevAnchor, nextAnchor *types.Anchor) <-chan *sm_inputs.ChainFetchStateDiffResults {
...
func (smT *stateManager) ConsensusStateProposal(ctx context.Context, anchor *types.Anchor) <-chan interface{} {
...
func (smT *stateManager) ConsensusDecidedState(ctx context.Context, anchor *types.Anchor) <-chan state.State {
