...
type SyncSM interface {
	//
	// State proposal.
	ProposedBaseAliasOutputReceived(baseAliasOutput *isctypes.Anchor) gpa.OutMessages
	StateProposalConfirmedByStateMgr() gpa.OutMessages
	//
	// Decided state.
	DecidedVirtualStateNeeded(decidedBaseAliasOutput *isctypes.Anchor) gpa.OutMessages
...
type syncSMImpl struct {
	...
	proposedBaseAliasOutput         *isctypes.Anchor
	stateProposalQueryInputsReadyCB func(baseAliasOutput *isctypes.Anchor) gpa.OutMessages
	stateProposalReceived           bool
	stateProposalReceivedCB         func(proposedAliasOutput *isctypes.Anchor) gpa.OutMessages
	//
	// Query for a decided Virtual State.
	decidedBaseAliasOutput         *isctypes.Anchor
	decidedStateQueryInputsReadyCB func(decidedBaseAliasOutput *isctypes.Anchor) gpa.OutMessages
...
func (sub *syncSMImpl) ProposedBaseAliasOutputReceived(baseAliasOutput *isctypes.Anchor) gpa.OutMessages {
...
func (sub *syncSMImpl) DecidedVirtualStateNeeded(decidedBaseAliasOutput *isctypes.Anchor) gpa.OutMessages {
