...
type SyncSM interface {
	//
	// State proposal.
	ProposedBaseAliasOutputReceived(baseAliasOutput *types.Anchor) gpa.OutMessages
	StateProposalConfirmedByStateMgr() gpa.OutMessages
	//
	// Decided state.
	DecidedVirtualStateNeeded(decidedBaseAliasOutput *types.Anchor) gpa.OutMessages
...
type syncSMImpl struct {
	...
	proposedBaseAliasOutput         *types.Anchor
	stateProposalQueryInputsReadyCB func(baseAliasOutput *types.Anchor) gpa.OutMessages
	stateProposalReceived           bool
	stateProposalReceivedCB         func(proposedAliasOutput *types.Anchor) gpa.OutMessages
	//
	// Query for a decided Virtual State.
	decidedBaseAliasOutput         *types.Anchor
	decidedStateQueryInputsReadyCB func(decidedBaseAliasOutput *types.Anchor) gpa.OutMessages
...
func (sub *syncSMImpl) ProposedBaseAliasOutputReceived(baseAliasOutput *types.Anchor) gpa.OutMessages {
...
func (sub *syncSMImpl) DecidedVirtualStateNeeded(decidedBaseAliasOutput *types.Anchor) gpa.OutMessages {
