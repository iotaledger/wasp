...
type SyncSM interface {
	//
	// State proposal.
	ProposedBaseAliasOutputReceived(baseAliasOutput *iscmove_types.Anchor) gpa.OutMessages
	StateProposalConfirmedByStateMgr() gpa.OutMessages
	//
	// Decided state.
	DecidedVirtualStateNeeded(decidedBaseAliasOutput *iscmove_types.Anchor) gpa.OutMessages
...
type syncSMImpl struct {
	...
	proposedBaseAliasOutput         *iscmove_types.Anchor
	stateProposalQueryInputsReadyCB func(baseAliasOutput *iscmove_types.Anchor) gpa.OutMessages
	stateProposalReceived           bool
	stateProposalReceivedCB         func(proposedAliasOutput *iscmove_types.Anchor) gpa.OutMessages
	//
	// Query for a decided Virtual State.
	decidedBaseAliasOutput         *iscmove_types.Anchor
	decidedStateQueryInputsReadyCB func(decidedBaseAliasOutput *iscmove_types.Anchor) gpa.OutMessages
...
func (sub *syncSMImpl) ProposedBaseAliasOutputReceived(baseAliasOutput *iscmove_types.Anchor) gpa.OutMessages {
...
func (sub *syncSMImpl) DecidedVirtualStateNeeded(decidedBaseAliasOutput *iscmove_types.Anchor) gpa.OutMessages {
