...
type SyncSM interface {
	//
	// State proposal.
	ProposedBaseAliasOutputReceived(baseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages
	StateProposalConfirmedByStateMgr() gpa.OutMessages
	//
	// Decided state.
	DecidedVirtualStateNeeded(decidedBaseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages
...
type syncSMImpl struct {
	...
	proposedBaseAliasOutput         *types.RefWithObject[types.Anchor]
	stateProposalQueryInputsReadyCB func(baseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages
	stateProposalReceived           bool
	stateProposalReceivedCB         func(proposedAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages
	//
	// Query for a decided Virtual State.
	decidedBaseAliasOutput         *types.RefWithObject[types.Anchor]
	decidedStateQueryInputsReadyCB func(decidedBaseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages
...
func (sub *syncSMImpl) ProposedBaseAliasOutputReceived(baseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages {
...
func (sub *syncSMImpl) DecidedVirtualStateNeeded(decidedBaseAliasOutput *types.RefWithObject[types.Anchor]) gpa.OutMessages {
