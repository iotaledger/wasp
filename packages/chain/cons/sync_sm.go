...
type SyncSM interface {
	//
	// State proposal.
	ProposedBaseAliasOutputReceived(baseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages
	StateProposalConfirmedByStateMgr() gpa.OutMessages
	//
	// Decided state.
	DecidedVirtualStateNeeded(decidedBaseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages
...
type syncSMImpl struct {
	...
	proposedBaseAliasOutput         *iscmove.RefWithObject[iscmove.Anchor]
	stateProposalQueryInputsReadyCB func(baseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages
	stateProposalReceived           bool
	stateProposalReceivedCB         func(proposedAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages
	//
	// Query for a decided Virtual State.
	decidedBaseAliasOutput         *iscmove.RefWithObject[iscmove.Anchor]
	decidedStateQueryInputsReadyCB func(decidedBaseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages
...
func (sub *syncSMImpl) ProposedBaseAliasOutputReceived(baseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages {
...
func (sub *syncSMImpl) DecidedVirtualStateNeeded(decidedBaseAliasOutput *iscmove.RefWithObject[iscmove.Anchor]) gpa.OutMessages {
