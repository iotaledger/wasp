...
type Mempool interface {
	ConsensusProposalAsync(ctx context.Context, aliasOutput *types.RefWithObject[types.Anchor], consensusID ConsensusID) <-chan []*isc.RequestRef
...
type StateMgr interface {
	...
	ConsensusStateProposal(
		ctx context.Context,
		anchor *types.RefWithObject[types.Anchor],
	) <-chan interface{}
...
func (cgr *ConsGr) Input(baseAliasOutput *types.RefWithObject[types.Anchor], outputCB func(*Output), recoverCB func()) {
