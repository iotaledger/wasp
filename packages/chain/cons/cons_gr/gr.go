...
type Mempool interface {
	ConsensusProposalAsync(ctx context.Context, aliasOutput *isctypes.Anchor, consensusID ConsensusID) <-chan []*isc.RequestRef
...
func (cgr *ConsGr) Input(baseAliasOutput *isctypes.Anchor, outputCB func(*Output), recoverCB func()) {
