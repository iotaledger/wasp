...
type Mempool interface {
	ConsensusProposalAsync(ctx context.Context, aliasOutput *iscmove_types.Anchor, consensusID ConsensusID) <-chan []*isc.RequestRef
...
func (cgr *ConsGr) Input(baseAliasOutput *iscmove_types.Anchor, outputCB func(*Output), recoverCB func()) {
