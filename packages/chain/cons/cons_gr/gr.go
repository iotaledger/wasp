...
type Mempool interface {
	ConsensusProposalAsync(ctx context.Context, aliasOutput *types.Anchor, consensusID ConsensusID) <-chan []*isc.RequestRef
...
func (cgr *ConsGr) Input(baseAliasOutput *types.Anchor, outputCB func(*Output), recoverCB func()) {
