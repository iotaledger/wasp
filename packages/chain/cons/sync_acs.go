...
type SyncACS interface {
	StateProposalReceived(proposedBaseAliasOutput *iscmove_types.Anchor) gpa.OutMessages
...
type syncACSImpl struct {
	BaseAliasOutput  *iscmove_types.Anchor
	RequestRefs      []*isc.RequestRef
	DSSIndexProposal []int
	TimeData         time.Time
	inputsReady      bool
	inputsReadyCB    func(baseAliasOutput *iscmove_types.Anchor, requestRefs []*isc.RequestRef, dssIndexProposal []int, timeData time.Time) gpa.OutMessages
	outputReady      bool
...
func (sub *syncACSImpl) StateProposalReceived(proposedBaseAliasOutput *iscmove_types.Anchor) gpa.OutMessages {
