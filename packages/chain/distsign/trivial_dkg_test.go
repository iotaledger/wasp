...
// a DistKeyGeneration for tests is presented in this file. Not sure, whi it fails.
...
// Just to debug DSS/DistKeyGeneration with a simple Shamir Secret Sharing.
func TestDSS(t *testing.T) {
	...
	adistKeyGen.VerifyPriShares(t, suite, nodeIDs, nodePKs, nodeSKs, longPK, priShares, commits, f)
}
