...
func (sm *stateManager) EventGetBatchMsg(msg *chain.GetBatchMsg) {
...
func (sm *stateManager) EventBatchHeaderMsg(msg *chain.BatchHeaderMsg) {
...
func (sm *stateManager) EventPendingBatchMsg(msg chain.PendingBatchMsg) {
