...
export const FuncSetCustomMetadata                   = 'setCustomMetadata';
export const FuncSetEVMGasRatio                      = 'setGasRatio';
export const FuncSetFeePolicy                        = 'setFeePolicy';
export const FuncSetGasLimits                        = 'setGasLimits';
export const FuncSetMaintenanceOff                   = 'stopMaintenance';
export const FuncSetMaintenanceOn                    = 'startMaintenance';
...
export const ViewGetCustomMetadata                   = 'getCustomMetadata';
export const ViewGetEVMGasRatio                      = 'getGasRatio';
...
export const HFuncSetCustomMetadata                   = new wasmtypes.ScHname(0xaa71b0b3);
export const HFuncSetEVMGasRatio                      = new wasmtypes.ScHname(0x70ebfe89);
...
export const HFuncSetMaintenanceOff                   = new wasmtypes.ScHname(0x4e017b6a);
export const HFuncSetMaintenanceOn                    = new wasmtypes.ScHname(0x742f0521);
...
export const HViewGetCustomMetadata                   = new wasmtypes.ScHname(0x02d4bac9);
export const HViewGetEVMGasRatio                      = new wasmtypes.ScHname(0x8188de1c);
