...
pub(crate) const FUNC_SET_EVM_GAS_RATIO                       : &str = "setGasRatio";
pub(crate) const FUNC_SET_FEE_POLICY                          : &str = "setFeePolicy";
pub(crate) const FUNC_SET_GAS_LIMITS                          : &str = "setGasLimits";
pub(crate) const FUNC_SET_MAINTENANCE_OFF                     : &str = "stopMaintenance";
pub(crate) const FUNC_SET_MAINTENANCE_ON                      : &str = "startMaintenance";
...
pub(crate) const VIEW_GET_EVM_GAS_RATIO                       : &str = "getGasRatio";
...
pub(crate) const HFUNC_SET_EVM_GAS_RATIO                       : ScHname = ScHname(0x70ebfe89);
...
pub(crate) const HFUNC_SET_MAINTENANCE_OFF                     : ScHname = ScHname(0x4e017b6a);
pub(crate) const HFUNC_SET_MAINTENANCE_ON                      : ScHname = ScHname(0x742f0521);
...
pub(crate) const HVIEW_GET_EVM_GAS_RATIO                       : ScHname = ScHname(0x8188de1c);
