...
pub(crate) const FUNC_SET_MAINTENANCE_OFF                     : &str = "setMaintenanceOff";
pub(crate) const FUNC_SET_MAINTENANCE_ON                      : &str = "setMaintenanceOn";
...
pub(crate) const HFUNC_SET_MAINTENANCE_OFF                     : ScHname = ScHname(0x0e2b35d4);
pub(crate) const HFUNC_SET_MAINTENANCE_ON                      : ScHname = ScHname(0x5e369f89);
