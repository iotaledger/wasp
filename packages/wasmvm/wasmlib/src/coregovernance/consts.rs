...
pub(crate) const PARAM_EVM_JSON_RPCURL    : &str = "e";
pub(crate) const PARAM_EVM_WEB_SOCKET_URL : &str = "w";
...
pub(crate) const RESULT_EVM_JSON_RPCURL        : &str = "e";
pub(crate) const RESULT_EVM_WEB_SOCKET_URL     : &str = "w";
