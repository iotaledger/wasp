...
pub(crate) const PARAM_PAYOUT_ADDRESS : &str = "s";
...
pub(crate) const RESULT_PAYOUT_ADDRESS         : &str = "s";
...
pub(crate) const FUNC_SET_PAYOUT_ADDRESS                      : &str = "setPayoutAddress";
...
pub(crate) const VIEW_GET_PAYOUT_ADDRESS                      : &str = "getPayoutAddress";
...
pub(crate) const HFUNC_SET_PAYOUT_ADDRESS                      : ScHname = ScHname(0x65e7c531);
...
pub(crate) const HVIEW_GET_PAYOUT_ADDRESS                      : ScHname = ScHname(0x2af7a8c3);
