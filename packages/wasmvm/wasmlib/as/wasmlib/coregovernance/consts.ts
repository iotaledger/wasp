...
export const FuncSetMaintenanceOff                   = 'setMaintenanceOff';
export const FuncSetMaintenanceOn                    = 'setMaintenanceOn';
...
export const HFuncSetMaintenanceOff                   = new wasmtypes.ScHname(0x0e2b35d4);
export const HFuncSetMaintenanceOn                    = new wasmtypes.ScHname(0x5e369f89);
