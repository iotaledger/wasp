...
func NewRequestTransaction(par NewRequestTransactionParams) (*iotago.Transaction, error) {
	panic("TODO: Implement transaction.NewRequestTransaction")
	// outputs := iotago.Outputs{}
	// sumBaseTokensOut := uint64(0)
	// sumTokensOut := make(map[iotago.NativeTokenID]*big.Int)
	// sumNFTsOut := make(map[sui.Address]bool)
...
func MakeRequestTransactionOutput(par NewRequestTransactionParams) iotago.Output {
	panic("TODO: Implement transaction.MakeRequestTransactionOutput")
	// req := par.Request
...
// 	sumNFTsOut map[sui.Address]bool,
// ) (
// 	iotago.Outputs,
// 	uint64,
// 	map[iotago.NativeTokenID]*big.Int,
// 	map[sui.Address]bool,
// ) {
