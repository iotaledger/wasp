...
func TestWriteAmplification(t *testing.T) {
	...
	originSD.Set(kv.Key(coreutil.StatePrefixBlockIndex), codec.Encode(uint32(0)))
	originSD.Set(kv.Key(coreutil.StatePrefixTimestamp), codec.EncodeTime(time.Unix(0, 0)))
