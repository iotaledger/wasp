...
var _ DistKeyPart = &distKeyPartImpl{}
...
func NewEmptyDistKeyPart(nodePrivKey *cryptolib.PrivateKey, edSuite suites.Suite, blsSuite Suite) DistKeyPart {
...
func DistKeyPartFromBytes(buf []byte, edSuite suites.Suite, blsSuite Suite, nodePrivKey *cryptolib.PrivateKey) (DistKeyPart, error) {
...
func (s *distKeyPartImpl) AssignCommonData(dks DistKeyPart) {
