...
func (env *Solo) RequestsForChain(tx *iotago.Transaction, chainID *iscp.ChainID) ([]iscp.RequestRaw, error) {
	env.glbMutex.RLock()
...
func (env *Solo) requestsByChain(tx *iotago.Transaction) map[iscp.ChainID][]iscp.RequestRaw {
...
func (ch *Chain) collateBatch() []iscp.RequestRaw {
