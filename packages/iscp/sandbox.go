...
type Sandbox interface {
	...
	Balance(col color.Color) uint64
	...
	Call(target, entryPoint Hname, params dict.Dict, transfer color.Balances) (dict.Dict, error)
	...
	IncomingTransfer() color.Balances
	...
	Send(target ledgerstate.Address, tokens color.Balances, metadata *SendMetadata, options ...SendOptions) bool
