...
func (n *nonceDistKeyGenerationImpl) subsystemFunc(subsystem byte, index int) (gpa.GPA, error) {
...
func (n *nonceDistKeyGenerationImpl) UnmarshalMessage(data []byte) (gpa.Message, error) {
