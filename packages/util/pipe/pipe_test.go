...
func testLimitedPriorityPipeNoLimitWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPriorityPipeFun func(priorityFun func(E) bool, limit int) Pipe[E], t *testing.T) {
...
func testLimitedPriorityPipeWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPriorityPipeFun func(priorityFun func(E) bool, limit int) Pipe[E], t *testing.T) {
	limit := 800
...
func testLimitedPipeNoLimitWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPipeFun func(limit int) Pipe[E], t *testing.T) {
	testDefaultPipeWriteReadLen(factory, makeLimitedPipeFun(1200), 1000, identityFunInt, t)
}

func testLimitedPipeWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPipeFun func(limit int) Pipe[E], t *testing.T) {
	limit := 800
	elementsToAdd := 1000
...
func testPriorityPipeWriteReadLen[E IntConvertible](factory Factory[E], makePriorityPipeFun func(func(E) bool) Pipe[E], t *testing.T) {
...
func testDefaultPipeWriteReadLen[E IntConvertible](factory Factory[E], p Pipe[E], elementsToWrite int, result func(index int) int, t *testing.T) {
...
func testLimitedPriorityPipeNoLimitConcurrentWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPriorityPipeFun func(priorityFun func(E) bool, limit int) Pipe[E], t *testing.T) {
	testPriorityPipeConcurrentWriteReadLen(factory, func(priorityFun func(E) bool) Pipe[E] {
		return makeLimitedPriorityPipeFun(priorityFun, 1200)
	}, t)
}

func testLimitedPriorityPipeConcurrentWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPriorityPipeFun func(priorityFun func(E) bool, limit int) Pipe[E], t *testing.T) {
	limit := 800
	ch := makeLimitedPriorityPipeFun(priorityFunMod3[E], limit)
	testPipeConcurrentWriteReadLen(factory, ch, 1000, limit, nil, t)
}

func testLimitedPipeNoLimitConcurrentWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPipeFun func(limit int) Pipe[E], t *testing.T) {
	result := identityFunInt
	testDefaultPipeConcurrentWriteReadLen(factory, makeLimitedPipeFun(1200), 1000, &result, t)
}

func testLimitedPipeConcurrentWriteReadLen[E IntConvertible](factory Factory[E], makeLimitedPipeFun func(limit int) Pipe[E], t *testing.T) {
	testPipeConcurrentWriteReadLen(factory, makeLimitedPipeFun(800), 1000, 800, nil, t)
}

func testPriorityPipeConcurrentWriteReadLen[E IntConvertible](factory Factory[E], makePriorityPipeFun func(func(E) bool) Pipe[E], t *testing.T) {
	ch := makePriorityPipeFun(priorityFunMod3[E])
	testDefaultPipeConcurrentWriteReadLen(factory, ch, 1000, nil, t)
}

func testDefaultPipeConcurrentWriteReadLen[E IntConvertible](factory Factory[E], p Pipe[E], elementsToWrite int, result *func(index int) int, t *testing.T) {
