...
func (w *WaspClientBackend) PostOnLedgerRequest(scName, funName string, transfer color.Balances, args dict.Dict) error {
...
func (w *WaspClientBackend) PostOffLedgerRequest(scName, funName string, transfer color.Balances, args dict.Dict) error {
