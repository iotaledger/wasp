...
//go:generate sh -c "solc --abi --bin --overwrite @iscmagic=`realpath ../../vm/core/evm/iscmagic` ./wiki-how-tos/GetBalance.sol -o ."
var (
...
//go:generate solc --abi --bin --overwrite RevertTest.sol -o .
var (
