...
export const KEY_NAME             = new Key32(-29);
export const KEY_PANIC            = new Key32(-30);
export const KEY_PARAMS           = new Key32(-31);
export const KEY_POST             = new Key32(-32);
export const KEY_RANDOM           = new Key32(-33);
export const KEY_REQUEST_ID       = new Key32(-34);
export const KEY_RESULTS          = new Key32(-35);
export const KEY_RETURN           = new Key32(-36);
export const KEY_STATE            = new Key32(-37);
export const KEY_TIMESTAMP        = new Key32(-38);
export const KEY_TRACE            = new Key32(-39);
export const KEY_TRANSFERS        = new Key32(-40);
export const KEY_UTILITY          = new Key32(-41);
export const KEY_VALID            = new Key32(-42);
export const KEY_ZZZZZZZ          = new Key32(-43);
// @formatter:on
