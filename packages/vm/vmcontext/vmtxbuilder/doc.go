...
// - ErrProtocolExceptionNotEnoughFundsForInternalDustDeposit when total number of base tokens available is not enough for dust deposit of the new internal output
