...
interface ISCSandbox {
    ...
    function registerERC20NativeToken(address sender, uint32 foundrySN, string memory name, string memory symbol, uint8 decimals, ISCAssets memory allowance) external;
}
