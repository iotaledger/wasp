...
func TestSetDefaultFeeNotAuthorized(t *testing.T) {
	...
	req := solo.NewCallParams(root.Contract.Name, root.FuncSetChainConfig.Name, root.ParamOwnerFee, 1000)
...
func TestSetContractFeeWithDefault(t *testing.T) {
	...
	req = solo.NewCallParams(root.Contract.Name, root.FuncSetChainConfig.Name, root.ParamValidatorFee, 1999).WithIotas(1)
	//.WithTransfers(
