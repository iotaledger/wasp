...
func testPingBaseTokens1(t *testing.T) {
	...
	require.EqualValues(t, userFundsAfter.L1.BaseTokens(), suiclient.FundsFromFaucetAmount-receipt.GasFeeCharged)
	require.EqualValues(t, commonBefore.BaseTokens(), commonAfter.BaseTokens())
	require.EqualValues(t, suiclient.FundsFromFaucetAmount-receipt.GasFeeCharged, userFundsAfter.L1.BaseTokens())
