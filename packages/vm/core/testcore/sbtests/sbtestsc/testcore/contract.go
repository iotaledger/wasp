...
type EstimateMinStorageDepositCall struct {
	Func *wasmlib.ScFunc
}
...
func (sc Funcs) EstimateMinStorageDeposit(ctx wasmlib.ScFuncCallContext) *EstimateMinStorageDepositCall {
	return &EstimateMinStorageDepositCall{Func: wasmlib.NewScFunc(ctx, HScName, HFuncEstimateMinStorageDeposit)}
}
