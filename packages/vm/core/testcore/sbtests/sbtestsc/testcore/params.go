...
func (s ImmutableWithdrawFromChainParams) BaseTokensWithdrawal() wasmtypes.ScImmutableUint64 {
	return wasmtypes.NewScImmutableUint64(s.proxy.Root(ParamBaseTokensWithdrawal))
}
...
func (s MutableWithdrawFromChainParams) BaseTokensWithdrawal() wasmtypes.ScMutableUint64 {
	return wasmtypes.NewScMutableUint64(s.proxy.Root(ParamBaseTokensWithdrawal))
}
