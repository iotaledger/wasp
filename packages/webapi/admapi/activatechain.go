...
func addChainEndpoints(adm echoswagger.ApiGroup, registryProvider registry.Provider, chainsProvider chains.Provider, allMetrics *metrics.Metrics) {
	c := &chainWebAPI{registryProvider, chainsProvider, allMetrics}
