...
func NewDKGService(dkShareRegistry registry.DKShareRegistry, dkgNodeProvider dkg.NodeProvider, trustedNetworkManager peering.TrustedNetworkManager) *DKGService {
	return &DKGService{
