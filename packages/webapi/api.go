...
func Init(
	...
	committeeService := services.NewCommitteeService(chainsProvider, networkProvider, distKeyPartsRegistry)
	...
	distKeyGenService := services.NewDistributedKeyGenerationService(distKeyPartsRegistry, distKeyGenNodeProvider, trustedNetworkManager)
