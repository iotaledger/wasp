...
// DistKeyPartsPostRequest is a POST request for creating new DistKeyPart.
type DistKeyPartsPostRequest struct {
	PeerPubKeysOrNames []string `json:"peerIdentities" swagger:"desc(Names or hex encoded public keys of trusted peers to run DistKeyGeneration on.),required"`
...
// DistKeyPartsInfo stands for the DistKeyPart representation, returned by the GET and POST methods.
type DistKeyPartsInfo struct {
