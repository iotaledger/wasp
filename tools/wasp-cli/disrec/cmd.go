...
func collectDKComponents(committeeKeysDir, committeeAddressStr string) ([]gpa.NodeID, []*cryptolib.KeyPair, []registry.DistKeyPartsRegistry, error) {
	...
	var dkRegistries []registry.DistKeyPartsRegistry
...
func loadNodeComponents(nodeDir, committeeAddressStr string) (gpa.NodeID, *cryptolib.KeyPair, registry.DistKeyPartsRegistry, bool) {
