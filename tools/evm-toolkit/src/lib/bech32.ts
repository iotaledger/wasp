...
export async function waspAddrBinaryFromBech32(nodeClient: SingleNodeClient, bech32String: string) {
  ...
  let receiverAddrBinary = Converter.hexToBytes(address.pubKeyHash);
