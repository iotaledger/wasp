...
` + markdownHeader
	...
	fmt.Printf("Create markdown file for %s...\n", app.Info().Name)
	...
	fmt.Printf("Markdown file for %s stored: %s", app.Info().Name, markdownFilePath)
}

func createDefaultConfigFile(app *app.App, configFilePath string, ignoreFlags map[string]struct{}) {
	fmt.Printf("Create default configuration file for %s...\n", app.Info().Name)
	...
	fmt.Printf("Default configuration file for %s stored: %s\n", app.Info().Name, configFilePath)
}
