...
const (
	incCodeIncrement           = coret.Hname(1)
	incCodeIncrementRepeat1    = coret.Hname(2)
	incCodeIncrementRepeatMany = coret.Hname(3)
	incCodeTest                = coret.Hname(4)
	incCodeNothing             = coret.Hname(5)
)
