...
func main() {
	...
	v2.Init(mockLog, swagger, nil, app.Version, nil, nil, nil, nil, nil, nil, &NodeIdentityProviderMock{}, nil, nil, nil, nil, authentication.AuthConfiguration{Scheme: authentication.AuthJWT}, []string{}, time.Second)
