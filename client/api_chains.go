...
func (a *ChainsApiService) AddAccessNodeExecute(r ApiAddAccessNodeRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"chainID"+"}", url.PathEscape(parameterToString(r.chainID, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"publicKey"+"}", url.PathEscape(parameterToString(r.publicKey, "")), -1)
...
func (a *ChainsApiService) GetRequestIDFromEVMTransactionIDExecute(r ApiGetRequestIDFromEVMTransactionIDRequest) (string, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"chainID"+"}", url.PathEscape(parameterToString(r.chainID, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"txHash"+"}", url.PathEscape(parameterToString(r.txHash, "")), -1)
...
func (r ApiGetStateValueRequest) Execute() ([]int32, *http.Response, error) {
...
// Execute executes the request
//  @return []int32
func (a *ChainsApiService) GetStateValueExecute(r ApiGetStateValueRequest) ([]int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath = strings.Replace(localVarPath, "{"+"chainID"+"}", url.PathEscape(parameterToString(r.chainID, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"stateKey"+"}", url.PathEscape(parameterToString(r.stateKey, "")), -1)
