...
To support events the ISC sandbox provides a very rudimentary interface. The function
...
to the ISC context's `event()` function. The string consists of the name of the event,
