...
We devised a simple solution to this problem. You can add a `typedefs` section to the
...
will automatically generate the in-between proxy types necessary to make all of this work.
