...
An emitter is used for filling corresponding values into templates under [`tools/schema/generator`](../../../tools/schema/generator).
...
To dynamically add a new key in templates (under [gotemplates](../../../tools/schema/generator/gotemplates), [rstemplates](../../../tools/schema/generator/rstemplates), and [tstemplates](../../../tools/schema/generator/tstemplates)), you can call `$#set` instruction, see section [set](#set) for more information.
...
Here, `tamplate` is any template which defined under [gotemplates](../../../tools/schema/generator/gotemplates), [rstemplates](../../../tools/schema/generator/rstemplates).
...
`condition` is either the predifined conditions (explained as following) or a key that may exist in `keys`.
...
Is the current processed field in basetype? `basetype`s are defined in the map `FieldTypes` in [`tools/schema/model/field.go`](../../../tools/schema/model/field.go).
...
Here `else` is a predefined empty template, which is defined at [`tools/schema/generator/templates.go`](../../../tools/schema/generator/templates.go).
