...
target. The implementation of the Wasm VM currently uses the open-source [Wasmtime](https://wasmtime.dev/) runtime
...
Both implementations are implemented using only a very small common subset of
...
programming: [proxy objects](proxies.mdx).
