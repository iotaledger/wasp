...
schema definition file then becomes the source of truth for how the smart contract works.

The schema definition file defines things like the state variables that the smart
...
data structures that the contract uses.
