...
the [function call context](context.mdx) section, the `on_load` function and skeleton
...
structure. In this case it is mutable because setOwner is a [Func](funcs.mdx). For [Views](views.mdx) this will be
