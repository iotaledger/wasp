...
function is being called to adapt it to changing requirements. The [Schema Tool](usage.mdx)
will generate such thunk functions to be able to properly set up calls to the smart contract
