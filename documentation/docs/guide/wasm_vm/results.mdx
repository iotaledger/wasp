...
variables for proxies to each result variable in the `results` map. The user will be able
to set the result variables through this structure, which is passed to the function.
