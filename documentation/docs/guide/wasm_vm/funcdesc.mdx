...
optional params and result maps through strict compile-time checked interfaces. They will
also allow you to initiate the function by calling it [synchronously](call.mdx), or
posting a request to run it [asynchronously](post.mdx).
