...
throughout this section. First we will select a _camel case_ name for our smart contract.
...
In the next section we will look at how a smart contract can access their state
