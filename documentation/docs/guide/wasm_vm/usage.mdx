...
We tried to make the creation of smart contracts as simple as possible. The *Schema Tool*
...
The next step is to navigateo into the new `mysmartcontract` subfolder and run the schema
...
If you want to generate Rust code, you should run the schema tool with the `-rust` option
like this:
