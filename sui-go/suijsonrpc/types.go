...
type TransferObject struct {
	Recipient sui.Address   `json:"recipient"`
	ObjectRef sui.ObjectRef `json:"object_ref"`
}
...
type Pay struct {
	Coins      []sui.ObjectRef `json:"coins"`
	Recipients []sui.Address   `json:"recipients"`
...
type SenderSignedData struct {
	...
	GasPayment *sui.ObjectRef `json:"gasPayment"`
