...
type _AccountFoundriesResponse AccountFoundriesResponse
...
func (o *AccountFoundriesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountFoundriesResponse := _AccountFoundriesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountFoundriesResponse)

	if err != nil {
		return err
	}

	*o = AccountFoundriesResponse(varAccountFoundriesResponse)
