...
type _InStateOutput InStateOutput
...
func (o *InStateOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varInStateOutput := _InStateOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInStateOutput)

	if err != nil {
		return err
	}

	*o = InStateOutput(varInStateOutput)
