...
type _CommitteeNode CommitteeNode
...
func (o *CommitteeNode) UnmarshalJSON(data []byte) (err error) {
	...
	varCommitteeNode := _CommitteeNode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommitteeNode)

	if err != nil {
		return err
	}

	*o = CommitteeNode(varCommitteeNode)
