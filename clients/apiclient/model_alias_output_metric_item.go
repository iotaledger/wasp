...
type _AliasOutputMetricItem AliasOutputMetricItem
...
func (o *AliasOutputMetricItem) UnmarshalJSON(data []byte) (err error) {
	...
	varAliasOutputMetricItem := _AliasOutputMetricItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAliasOutputMetricItem)

	if err != nil {
		return err
	}

	*o = AliasOutputMetricItem(varAliasOutputMetricItem)
