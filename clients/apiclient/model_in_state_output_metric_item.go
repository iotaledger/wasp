...
type _InStateOutputMetricItem InStateOutputMetricItem
...
func (o *InStateOutputMetricItem) UnmarshalJSON(data []byte) (err error) {
	...
	varInStateOutputMetricItem := _InStateOutputMetricItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInStateOutputMetricItem)

	if err != nil {
		return err
	}

	*o = InStateOutputMetricItem(varInStateOutputMetricItem)
