...
type _PeeringNodeIdentityResponse PeeringNodeIdentityResponse
...
func (o *PeeringNodeIdentityResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPeeringNodeIdentityResponse := _PeeringNodeIdentityResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPeeringNodeIdentityResponse)

	if err != nil {
		return err
	}

	*o = PeeringNodeIdentityResponse(varPeeringNodeIdentityResponse)
