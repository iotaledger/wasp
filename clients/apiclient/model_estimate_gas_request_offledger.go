...
type _EstimateGasRequestOffledger EstimateGasRequestOffledger
...
func (o *EstimateGasRequestOffledger) UnmarshalJSON(data []byte) (err error) {
	...
	varEstimateGasRequestOffledger := _EstimateGasRequestOffledger{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEstimateGasRequestOffledger)

	if err != nil {
		return err
	}

	*o = EstimateGasRequestOffledger(varEstimateGasRequestOffledger)
