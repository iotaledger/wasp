...
export interface CorecontractsApiAccountsGetObjectDataRequest {
    /**
     * Object ID (Hex)
     * Defaults to: undefined
     * @type string
     * @memberof CorecontractsApiaccountsGetObjectData
     */
    objectID: string
    /**
     * Block index or trie root
...
export class ObjectCorecontractsApi {
     ...
     * @param param the request object
     */
    public accountsGetObjectDataWithHttpInfo(param: CorecontractsApiAccountsGetObjectDataRequest, options?: Configuration): Promise<HttpInfo<IotaObject>> {
        return this.api.accountsGetObjectDataWithHttpInfo(param.objectID, param.block,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public accountsGetObjectData(param: CorecontractsApiAccountsGetObjectDataRequest, options?: Configuration): Promise<IotaObject> {
        return this.api.accountsGetObjectData(param.objectID, param.block,  options).toPromise();
    }
