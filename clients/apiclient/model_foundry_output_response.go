...
type _FoundryOutputResponse FoundryOutputResponse
...
func (o *FoundryOutputResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFoundryOutputResponse := _FoundryOutputResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFoundryOutputResponse)

	if err != nil {
		return err
	}

	*o = FoundryOutputResponse(varFoundryOutputResponse)
