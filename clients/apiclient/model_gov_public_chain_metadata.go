...
type _GovPublicChainMetadata GovPublicChainMetadata
...
func (o *GovPublicChainMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varGovPublicChainMetadata := _GovPublicChainMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGovPublicChainMetadata)

	if err != nil {
		return err
	}

	*o = GovPublicChainMetadata(varGovPublicChainMetadata)
