...
type _ErrorMessageFormatResponse ErrorMessageFormatResponse
...
func (o *ErrorMessageFormatResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorMessageFormatResponse := _ErrorMessageFormatResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorMessageFormatResponse)

	if err != nil {
		return err
	}

	*o = ErrorMessageFormatResponse(varErrorMessageFormatResponse)
