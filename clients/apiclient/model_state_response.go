...
type _StateResponse StateResponse
...
func (o *StateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varStateResponse := _StateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStateResponse)

	if err != nil {
		return err
	}

	*o = StateResponse(varStateResponse)
