...
func TestSuiEventDecode(t *testing.T) {
	receivingMessage := []byte(`{
      ...
      "type": "0xdee9::clob_v2::OrderPlaced<0x2::iotago::IOTA, 0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>",
      "parsedJson": {
	...
	var event iotajsonrpc.SuiEvent
