...
const (
	...
	// Can be uncommented once a public Test/Mainnet is online
	//DevnetWebsocketEndpointURL   = "wss://api.iota-rebased-alphanet.iota.cafe/websocket"
	//MainnetWebsocketEndpointURL  = "wss://api.iota-rebased-alphanet.iota.cafe/websocket"
