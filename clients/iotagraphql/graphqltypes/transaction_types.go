...
// Requires IotaTransactionBlockResponseOptions.ShowObjectChanges to be true.
...
// objectChangeData represents the common fields between Created and Mutated object changes.
...
// getObjectByName is a helper that finds an object by module and name using a matcher function.
func (r *IotaTransactionBlockResponse) getObjectByName(
	module string,
	objectName string,
	changeType string,
	getChangeData func(change *JSONRPCObjectChange) *objectChangeData,
	...
	for _, change := range r.ObjectChanges {
		...
		if data != nil {
			...
			if resource.Contains(nil, module, objectName) {
				if ref != nil {
					return nil, fmt.Errorf("multiple %s objects found for %s::%s: first = %v, second = %v",
						changeType, module, objectName,
						string(lo.Must(json.Marshal(prevObj))),
						string(lo.Must(json.Marshal(data))),
					)
				}
...
// GetCreatedObjectByName returns the created object by name.
// Requires ShowObjectChanges option to be true.
func (r *IotaTransactionBlockResponse) GetCreatedObjectByName(module string, objectName string) (*iotago.ObjectRef, error) {
	return r.getObjectByName(module, objectName, "created", func(change *JSONRPCObjectChange) *objectChangeData {
		if change.Created == nil {
			return nil
		}
		return &objectChangeData{
			ObjectType: change.Created.ObjectType,
...
// GetMutatedObjectByName returns the mutated object by name.
// Requires ShowObjectChanges option to be true.
func (r *IotaTransactionBlockResponse) GetMutatedObjectByName(module string, objectName string) (*iotago.ObjectRef, error) {
	return r.getObjectByName(module, objectName, "mutated", func(change *JSONRPCObjectChange) *objectChangeData {
		if change.Mutated == nil {
			return nil
		}
		return &objectChangeData{
			ObjectType: change.Mutated.ObjectType,
			ObjectID:   change.Mutated.ObjectID,
			Version:    change.Mutated.Version,
...
// getCoinByType is a helper that finds a coin by module and type using a matcher function.
func (r *IotaTransactionBlockResponse) getCoinByType(
	module string,
	coinType string,
	changeType string,
	getChangeData func(change *JSONRPCObjectChange) *objectChangeData,
		...
		if data != nil {
			...
			if resource.Module == "coin" && resource.SubType1 != nil {
				if resource.SubType1.Module == module && resource.SubType1.ObjectName == coinType {
					if ref != nil {
						return nil, fmt.Errorf("multiple %s coins found for %s::%s: first = %v, second = %v",
							changeType, module, coinType,
							string(lo.Must(json.Marshal(prevObj))),
							string(lo.Must(json.Marshal(data))),
						)
					}
...
// GetCreatedCoinByType returns the created coin by type.
// Requires ShowObjectChanges option to be true.
func (r *IotaTransactionBlockResponse) GetCreatedCoinByType(module string, coinType string) (*iotago.ObjectRef, error) {
	return r.getCoinByType(module, coinType, "created", func(change *JSONRPCObjectChange) *objectChangeData {
		if change.Created == nil {
			return nil
		}
		return &objectChangeData{
...
// GetMutatedCoinByType returns the mutated coin by type.
// Requires ShowObjectChanges option to be true.
func (r *IotaTransactionBlockResponse) GetMutatedCoinByType(module string, coinType string) (*iotago.ObjectRef, error) {
	return r.getCoinByType(module, coinType, "mutated", func(change *JSONRPCObjectChange) *objectChangeData {
		if change.Mutated == nil {
			return nil
		}
		return &objectChangeData{
