...
import "github.com/iotaledger/wasp/sui-go/suijsonrpc"
...
type Assets struct {
	Coins suijsonrpc.Coins // only some fields in suijsonrpc.Coin will have value here (having values in some fields are just don't make sense)
