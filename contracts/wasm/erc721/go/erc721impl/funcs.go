...
func canOperate(state erc721.MutableErc721State, caller, owner wasmtypes.ScAgentID) bool {
	if caller == owner {
		return true
	}
...
func canTransfer(state erc721.MutableErc721State, caller, owner wasmtypes.ScAgentID, tokenID wasmtypes.ScHash) bool {
...
func transfer(ctx wasmlib.ScFuncContext, state erc721.MutableErc721State, from, to wasmtypes.ScAgentID, tokenID wasmtypes.ScHash) {
