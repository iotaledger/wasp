...
export const ParamAddressBytes    = "addressBytes";
export const ParamAddressString   = "addressString";
...
export const ParamBigIntBytes     = "bigIntBytes";
export const ParamBigIntString    = "bigIntString";
...
export const ParamEthAddress      = "ethAddress";
export const ParamHash            = "hash";
export const ParamHashBytes       = "hashBytes";
export const ParamHashString      = "hashString";
export const ParamHname           = "hname";
export const ParamHnameBytes      = "hnameBytes";
export const ParamHnameString     = "hnameString";
...
export const ParamNftIDBytes      = "nftIDBytes";
export const ParamNftIDString     = "nftIDString";
export const ParamParam           = "this";
export const ParamRecordIndex     = "recordIndex";
export const ParamRequestID       = "requestID";
export const ParamRequestIDBytes  = "requestIDBytes";
export const ParamRequestIDString = "requestIDString";
export const ParamRhs             = "rhs";
export const ParamScAddress       = "scAddress";
export const ParamScAgentID       = "scAgentID";
export const ParamScBigInt        = "scBigInt";
export const ParamScHash          = "scHash";
export const ParamScHname         = "scHname";
export const ParamScNftID         = "scNftID";
export const ParamScRequestID     = "scRequestID";
export const ParamScTokenID       = "scTokenID";
export const ParamShift           = "shift";
export const ParamString          = "string";
export const ParamTokenID         = "tokenID";
export const ParamTokenIDBytes    = "tokenIDBytes";
export const ParamTokenIDString   = "tokenIDString";
...
export const ResultQuo       = "quo";
export const ResultRandom    = "random";
export const ResultRecord    = "record";
export const ResultRemainder = "remainder";
...
export const ViewBigIntDivMod                   = "bigIntDivMod";
...
export const ViewCheckAddress                   = "checkAddress";
export const ViewCheckAgentID                   = "checkAgentID";
export const ViewCheckBigInt                    = "checkBigInt";
export const ViewCheckBool                      = "checkBool";
export const ViewCheckBytes                     = "checkBytes";
export const ViewCheckEthAddressAndAgentID      = "checkEthAddressAndAgentID";
export const ViewCheckHash                      = "checkHash";
export const ViewCheckHname                     = "checkHname";
export const ViewCheckIntAndUint                = "checkIntAndUint";
export const ViewCheckNftID                     = "checkNftID";
export const ViewCheckRequestID                 = "checkRequestID";
export const ViewCheckString                    = "checkString";
export const ViewCheckTokenID                   = "checkTokenID";
...
export const HViewBigIntDivMod                   = new wasmtypes.ScHname(0x0bcaf323);
...
export const HViewCheckAddress                   = new wasmtypes.ScHname(0x64b8add5);
export const HViewCheckAgentID                   = new wasmtypes.ScHname(0x27ae5137);
export const HViewCheckBigInt                    = new wasmtypes.ScHname(0x3497622b);
export const HViewCheckBool                      = new wasmtypes.ScHname(0xd8a476d2);
export const HViewCheckBytes                     = new wasmtypes.ScHname(0xcef76f43);
export const HViewCheckEthAddressAndAgentID      = new wasmtypes.ScHname(0xe01ad77e);
export const HViewCheckHash                      = new wasmtypes.ScHname(0x6b391dec);
export const HViewCheckHname                     = new wasmtypes.ScHname(0x7690daec);
export const HViewCheckIntAndUint                = new wasmtypes.ScHname(0xfe928771);
export const HViewCheckNftID                     = new wasmtypes.ScHname(0xcf852738);
export const HViewCheckRequestID                 = new wasmtypes.ScHname(0xeb1244dc);
export const HViewCheckString                    = new wasmtypes.ScHname(0xb2c3fb27);
export const HViewCheckTokenID                   = new wasmtypes.ScHname(0xeea106dc);
