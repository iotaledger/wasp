...
impl ImmutableTakeBalanceResults {
    pub fn tokens(&self) -> ScImmutableUint64 {
        ScImmutableUint64::new(self.proxy.root(RESULT_TOKENS))
    }
}
...
impl MutableTakeBalanceResults {
    pub fn tokens(&self) -> ScMutableUint64 {
        ScMutableUint64::new(self.proxy.root(RESULT_TOKENS))
    }
}
...
#[derive(Clone)]
pub struct ImmutableTokenBalanceResults {
    pub(crate) proxy: Proxy,
}

impl ImmutableTokenBalanceResults {
    pub fn tokens(&self) -> ScImmutableUint64 {
        ScImmutableUint64::new(self.proxy.root(RESULT_TOKENS))
    }
}
...
#[derive(Clone)]
pub struct MutableTokenBalanceResults {
    pub(crate) proxy: Proxy,
}

impl MutableTokenBalanceResults {
    pub fn tokens(&self) -> ScMutableUint64 {
        ScMutableUint64::new(self.proxy.root(RESULT_TOKENS))
    }
}
