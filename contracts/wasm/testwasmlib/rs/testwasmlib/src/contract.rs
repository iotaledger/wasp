...
pub struct TokenBalanceCall {
    pub func: ScView,
    pub results: ImmutableTokenBalanceResults,
}
...
impl ScFuncs {
    ...
    pub fn token_balance(_ctx: &dyn ScViewCallContext) -> TokenBalanceCall {
        let mut f = TokenBalanceCall {
            func: ScView::new(HSC_NAME, HVIEW_TOKEN_BALANCE),
            results: ImmutableTokenBalanceResults { proxy: Proxy::nil() },
        };
        ScView::link_results(&mut f.results.proxy, &f.func);
        f
    }
