...
pub(crate) const IDX_STATE_COUNTER:          usize = 28;
pub(crate) const IDX_STATE_HNAME_EP:         usize = 29;
pub(crate) const IDX_STATE_INTS:             usize = 30;
pub(crate) const IDX_STATE_MINTED_COLOR:     usize = 31;
pub(crate) const IDX_STATE_MINTED_SUPPLY:    usize = 32;
