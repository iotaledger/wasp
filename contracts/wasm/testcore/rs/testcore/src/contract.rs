...
pub struct EstimateMinStorageDepositCall {
    pub func: ScFunc,
}
...
impl ScFuncs {
    ...
    pub fn estimate_min_storage_deposit(_ctx: &dyn ScFuncCallContext) -> EstimateMinStorageDepositCall {
        EstimateMinStorageDepositCall {
            func: ScFunc::new(HSC_NAME, HFUNC_ESTIMATE_MIN_STORAGE_DEPOSIT),
        }
    }
