...
const EXPORT_MAP: ScExportMap = ScExportMap {
    names: &[
        ...
        FUNC_DO_NOTHING,
        FUNC_ESTIMATE_MIN_STORAGE_DEPOSIT,
        FUNC_INC_COUNTER,
        FUNC_INFINITE_LOOP,
        FUNC_INIT,
    ...
    funcs: &[
        ...
        func_estimate_min_storage_deposit_thunk,
...
pub struct EstimateMinStorageDepositContext {
    state: MutableTestCoreState,
}

fn func_estimate_min_storage_deposit_thunk(ctx: &ScFuncContext) {
    ctx.log("testcore.funcEstimateMinStorageDeposit");
    let f = EstimateMinStorageDepositContext {
        state: MutableTestCoreState { proxy: state_proxy() },
    };
    func_estimate_min_storage_deposit(ctx, &f);
    ctx.log("testcore.funcEstimateMinStorageDeposit ok");
}
...
fn func_withdraw_from_chain_thunk(ctx: &ScFuncContext) {
    ...
    ctx.require(f.params.base_tokens_withdrawal().exists(), "missing mandatory baseTokensWithdrawal");
    ctx.require(f.params.chain_id().exists(), "missing mandatory chainID");
