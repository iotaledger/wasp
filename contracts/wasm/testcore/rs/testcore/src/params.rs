...
impl ImmutableWithdrawFromChainParams {
    pub fn base_tokens_withdrawal(&self) -> ScImmutableUint64 {
        ScImmutableUint64::new(self.proxy.root(PARAM_BASE_TOKENS_WITHDRAWAL))
    }
...
impl MutableWithdrawFromChainParams {
    pub fn base_tokens_withdrawal(&self) -> ScMutableUint64 {
        ScMutableUint64::new(self.proxy.root(PARAM_BASE_TOKENS_WITHDRAWAL))
    }
