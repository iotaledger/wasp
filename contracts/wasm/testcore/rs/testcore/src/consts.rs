...
pub const PARAM_BASE_TOKENS_WITHDRAWAL : &str = "baseTokensWithdrawal";
...
pub const FUNC_ESTIMATE_MIN_STORAGE_DEPOSIT      : &str = "estimateMinStorageDeposit";
...
pub const HFUNC_ESTIMATE_MIN_STORAGE_DEPOSIT      : ScHname = ScHname(0xf5d411cb);
