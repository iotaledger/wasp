...
func setupTest(t *testing.T) *wasmsolo2.SoloContext {
	return wasmsolo2.NewSoloContext(t, fairroulette.ScName, fairroulette.OnLoad)
}
...
func TestBets(t *testing.T) {
	ctx := setupTest(t)
	var better [10]*wasmsolo2.SoloAgent
	for i := 0; i < 10; i++ {
