...
pub const KEY_NAME             : Key32 = Key32(-29);
pub const KEY_PANIC            : Key32 = Key32(-30);
pub const KEY_PARAMS           : Key32 = Key32(-31);
pub const KEY_POST             : Key32 = Key32(-32);
pub const KEY_RANDOM           : Key32 = Key32(-33);
pub const KEY_REQUEST_ID       : Key32 = Key32(-34);
pub const KEY_RESULTS          : Key32 = Key32(-35);
pub const KEY_RETURN           : Key32 = Key32(-36);
pub const KEY_STATE            : Key32 = Key32(-37);
pub const KEY_TIMESTAMP        : Key32 = Key32(-38);
pub const KEY_TRACE            : Key32 = Key32(-39);
pub const KEY_TRANSFERS        : Key32 = Key32(-40);
pub const KEY_UTILITY          : Key32 = Key32(-41);
pub const KEY_VALID            : Key32 = Key32(-42);
pub const KEY_ZZZZZZZ          : Key32 = Key32(-43);
// @formatter:on
