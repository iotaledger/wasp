...
pub const FUNC_TEST_CONTRACT_ID_FULL: &str = "testContractIDFull";
...
pub const VIEW_TEST_CONTRACT_ID_VIEW: &str = "testContractIDView";
...
pub const HFUNC_TEST_CONTRACT_ID_FULL: ScHname = ScHname(0x95934282);
...
pub const HVIEW_TEST_CONTRACT_ID_VIEW: ScHname = ScHname(0x28a02913);
