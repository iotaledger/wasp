    ...
    [_stylesModule.default.navbarHidden]: hideOnScroll && !isNavbarVisible
      ...
      <div className="navbar__inner">
        <div className="navbar__items">
          {items != null && items.length !== 0 && <button aria-label="Navigation bar toggle" className="navbar__toggle clean-btn" type="button" tabIndex={0} onClick={showSidebar} onKeyDown={showSidebar}>
              <_IconMenu.default />
            </button>}
        ...
        <div className="navbar__items navbar__items--right">
          ...
          {!disableColorModeSwitch && <_Toggle.default className={_stylesModule.default.displayOnlyInLargeViewport} checked={isDarkTheme} onChange={onToggleChange} />}
      ...
      <div className="navbar-sidebar">
        <div className="navbar-sidebar__brand">
          ...
          {!disableColorModeSwitch && sidebarShown && <_Toggle.default checked={isDarkTheme} onChange={onToggleChange} />}
        </div>
